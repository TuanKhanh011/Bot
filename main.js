...
const { Sequelize, sequelize } = require("./SystemData/database");
    ...
    try {
        try {
            ...
            const sequelize2 = new Sequelize({
                dialect: "sqlite",
                host: __dirname + '/SystemData/datasqlite/antists.sqlite',
                logging: false
            });
        ...
        authentication.sequelize = sequelize;
        const models = require('./SystemData/database/model')(authentication);
        const botData = {};
